...
const AppContent: React.FC = () => {
  ...
  const handleTabChange = (tab: string) => {
    ...
    // Reset filters if switching to tasks manually from sidebar
    if (tab === 'tasks' && !taskFilters.special) {
      setTaskFilters({});
    }
  };

  const navigateToTasks = (filters: typeof taskFilters) => {
  ...
  const renderView = () => {
    switch (activeTab) {
      case 'dashboard': return <Dashboard onNavigateTasks={navigateToTasks} />;
      case 'pipeline': return <Pipeline />;
      case 'closed-deals': return <ClosedDeals />;
      case 'clients': return <Clients />;
      case 'tasks': return <Tasks initialFilters={taskFilters} />;
      case 'staff': return <Staff />;
      case 'freelancers': return <Freelancers />;
      case 'files': return <Files />;
      default: return <Dashboard onNavigateTasks={navigateToTasks} />;
    }
  };
