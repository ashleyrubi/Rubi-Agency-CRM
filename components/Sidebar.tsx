...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, isOpen, onClose, profile }) => {
  ...
  const sidebarClasses = `
    fixed inset-y-0 right-0 z-[50] w-64 bg-white dark:bg-dark-card border-l lg:border-l-0 lg:border-r border-gray-100 dark:border-dark-border 
    transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:left-0 lg:right-auto
