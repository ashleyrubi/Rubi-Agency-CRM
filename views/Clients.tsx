  ...
  return (
    <div className="p-6 md:p-10">
      <PageHeader 
        ...
        description="Directory of core partners."
        actions={<Button icon={Plus} size="sm" onClick={handleOpenAdd}>Add Client</Button>}
      />

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
        {clients.map(client => (
          <Card key={client.id} className="p-5 md:p-8 group hover:border-brand-pink/50 transition-all flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="p-2.5 bg-gray-50 dark:bg-dark-bg text-gray-400 hover:text-brand-pink rounded-lg transition-colors border border-gray-100 dark:border-dark-border"
                  >
            ...
            <div className="mt-8 md:mt-10 pt-6 border-t border-gray-50 dark:border-dark-border grid grid-cols-3 gap-3">
              <Button variant="outline" className="px-1" size="sm" onClick={() => openPeopleModal(client)}>People</Button>
              <Button variant="outline" className="px-1" size="sm">Project</Button>
